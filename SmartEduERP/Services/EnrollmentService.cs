...

{
    ...
    public async Task<List<Enrollment>> GetAllEnrollmentsIncludingArchivedAsync()
...

    {
        ...
        var distribution = await _context.Enrollments
            ...
            .GroupBy(e => string.IsNullOrWhiteSpace(e.AcademicYear) ? "Not Specified" : e.AcademicYear)
        ...
        return distribution.ToDictionary(x => x.AcademicYear, x => x.Count);
